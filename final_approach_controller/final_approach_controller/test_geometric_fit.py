...
def extra():
    ...
    cyl1 = go.Surface(x=x1, y=y1, z=z1, colorscale=colorscale, showscale=False, opacity=0.5)
    ...
    cyl2 = go.Surface(x=x2, y=y2, z=z2, colorscale=colorscale, showscale=False, opacity=0.7)
