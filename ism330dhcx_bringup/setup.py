...
package_name = "ism330dhcx_bringup"
...
setup(
    ...
    description="Bringup package for the ISM330DHCX IMU sensor",
    license="BSD-3-Clause",
    tests_require=["pytest"],
    entry_points={
        "console_scripts": [
            "ism330dhcx_filter_node = ism330dhcx_bringup.ism330dhcx_filter_node:main",
        ],
    },
)
