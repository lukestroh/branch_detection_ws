...
def launch_setup(context: LaunchContext, *args, **kwargs):
    ...
    #     Sensor launches
    # =========================
    launch_vl53l4cd_bringup = IncludeLaunchDescription(
        AnyLaunchDescriptionSource(
            os.path.join(dir_vl53l4cd_bringup, "launch", "vl53l4cd.launch.py"),
        ),
        launch_arguments=[
            ("sensor_quantity", sensor_quantity),
        ],
        condition=IfCondition([str(sensor_type.perform(context) == "vl53l4cd")]),
    )
    ...
    nodes_to_return = [node_micro_ros_agent, launch_vl53l4cd_bringup, launch_vl53l8cx_bringup, launch_vl6180_bringup]
...
def generate_launch_description():
    declared_configs = [
        ...
        dict(name="sensor_type", default_value="vl53l4cd", choices=["vl53l4cd", "vl53l8cx", "vl6180"]),
