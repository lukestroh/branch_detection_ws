...
def setup_launch(context: LaunchContext, *args, **kwargs):
    ...
    _to_launch = [node_contact_watcher, node_wrench_filter, node_fake_wrench_publisher]
...
def generate_launch_description():
    ...
    declared_args.append(
        DeclareLaunchArgument(
            name="use_fake_force_data",
            default_value="false",
            choices=["true", "false"],
            description="Publish fake force/torque data for the admittance controller",
        )
    )
