...
class FakeWrenchPublisherNode(Node):
    def __init__(self) -> None:
        ...
        # Publishers
        self._pub_wrench_raw = self.create_publisher(msg_type=WrenchStamped, topic="/wrench", qos_profile=1)

        # Timers
        self._timer_pub_wrench_raw = self.create_timer(timer_period_sec=0.1, callback=self._timer_cb__pub_wrench_raw)
