...
def launch_setup(context, *args, **kwargs):
    ...
    controllers_yaml = load_yaml("branch_detection_system_moveit_config", "config/controllers.yaml")
    ...
    servo_yaml = load_yaml("branch_detection_system_moveit_config", "config/ur_servo.yaml")
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="branch_detection_system_moveit_config",
