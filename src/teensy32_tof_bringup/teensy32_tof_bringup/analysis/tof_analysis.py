...
def plot(data):
    ...
    fig.add_trace(go.Scatter(x=t, y=raw_data["tof0"], name="tof0 raw"))
    fig.add_trace(go.Scatter(x=t, y=raw_data["tof1"], name="tof1 raw"))
    fig.add_trace(go.Scatter(x=t_filtered, y=filtered_data["tof0_filtered"], name="tof0 filtered"))
    fig.add_trace(go.Scatter(x=t_filtered, y=filtered_data["tof1_filtered"], name="tof1 filtered"))
