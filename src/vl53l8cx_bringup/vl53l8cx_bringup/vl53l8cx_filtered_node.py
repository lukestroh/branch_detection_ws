...
class VL53L8CXFilterNode(Node):
    ...
    def __init__(self, node_name="vl53l8cx_filtered_node") -> None:
        ...
        filepath_covariances = (
            self.declare_parameter("filepath_covariances", value=Parameter.Type.STRING)
            .get_parameter_value()
            .string_value
        )
        ...
        self.vl53l8cx_msg_filtered.data = array(
            "d", np.zeros(self.frame_size[0] * self.frame_size[1], dtype=np.float64)
        )
